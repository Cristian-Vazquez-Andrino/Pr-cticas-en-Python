"""
Geometría computacional, Práctica 2
...
# Indicamos la dirección el la que se encuentran los archivos
# con los que vamos a trabajar
a1 ="D:/python/GC/p2/junio2023.txt"
a2 = "D:/python/GC/p2/Personas_de_villa_laminera.txt"
a3 = "D:/python/GC/p2/Franjas_de_edad.txt"
...
# son el nível de estrés y la afición a dulces
X = np.loadtxt(a2, skiprows=1)

# Este segundo sistema Y tan sólo debe utilizarse para medir el error
# de predicción. El sistema es igual al anterior con la diferencia de
# que cada elemento (persona) tiene un nuevo estado: la franja de edad
# a la que pertenece cada persona.
Y = np.loadtxt(a3, skiprows=1)

# Construimos un array con los estados "franja de edad" de cada elemento.
franjas_correctas = Y[:, 0]
